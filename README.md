![mizuhara](https://telegra.ph/file/4e399b513839caff84c95.jpg)
# Mizuhara Robot 
...
This file should be placed in your `Mizuki` folder, alongside the `__main__.py` file. 
...
```
from Mizuki.sample_config import Config
